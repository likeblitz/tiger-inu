...
export default function AboutSection() {
  return (
    <div id="about" className="bg-yellow-400 py-24 relative overflow-hidden">
      {/* Floating Cat Paws Background - same size */}
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ top: "10%", left: "3%", animationDelay: "0s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ top: "20%", right: "3%", animationDelay: "1.5s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ bottom: "30%", left: "5%", animationDelay: "3s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ bottom: "15%", right: "5%", animationDelay: "4.5s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ top: "35%", left: "10%", animationDelay: "2s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ top: "55%", right: "8%", animationDelay: "0.8s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ bottom: "45%", left: "2%", animationDelay: "3.8s" }} />
      <PawPrint className="absolute w-8 h-8 text-black/20 animate-glow-float z-0" 
        style={{ top: "65%", right: "2%", animationDelay: "2.5s" }} />
